...
# the following is just maturity data used in gadget
# look in the Data/ directory of your model
igfs.mat <- '~/gadget/gadget-models/path/to/igfsMaturity.txt'
mat.data <- read.table(igfs.mat, sep='\t', header=T)
