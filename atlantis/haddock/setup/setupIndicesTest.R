## this is a version where I am setting up survey indices that do not include length
## including lengths in the surveys is possibly problematic as I have removed 
## much of the length and age data when importing into mfdb
