...
init.params[grep('linf', rn), ] <- c('had.linf', 116.0184505, 75, 150, 0)
init.params[grep('k', rn), ] <- c('had.k', 0.1389627, 0.01, 0.30, 0)
...
init.params['had.recl',-1] <- c(15.2704, 1, 40,0)
...
init.params[grepl('alpha',init.params$switch),'optimise'] <- 0
...
init.params[grepl('l50',init.params$switch),'optimise'] <- 0

init.params[init.params$switch=='igfs.alpha',] <- c('igfs.alpha', .046, 0.001, 3, 0)
init.params[init.params$switch=='igfs.l50',] <- c('igfs.l50', 49, 5, 50, 0)
init.params[init.params$switch=='aut.alpha',] <- c('aut.alpha', 0.046, 0.001, 3, 0)
init.params[init.params$switch=='aut.l50',] <- c('aut.l50', 49, 5, 50, 0)
