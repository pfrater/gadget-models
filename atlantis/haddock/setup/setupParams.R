...
init.params[grepl('l50',init.params$switch),'upper'] <- 120
...
init.params[init.params$switch=='igfs.l50',] <- c('igfs.l50', 49, 5, 120, 1)
init.params[init.params$switch=='aut.alpha',] <- c('aut.alpha', 0.046, 0.001, 3, 1)
init.params[init.params$switch=='aut.l50',] <- c('aut.l50', 49, 5, 120, 1)
